...
namespace DataAccess.DAO
{
    ...
    public class SqlDao
    {
        ...
        private SqlDao()
        {
            ...
            _connectionString = @"Data Source=srv-sqldatabase-dbjpastora1.database.windows.net;Initial Catalog=cenfocinameas-db;Persist Security Info=True;User ID=sysman;Password=Cenfotec12345!;Trust Server Certificate=True"; // Reemplaza con tu cadena de conexión real
        }
